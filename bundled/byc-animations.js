(function(global, factory) {
  ...
  */
  ...
  var _gsap = {
    ...
    quickTo: function quickTo(target, property, vars) {
      var _setDefaults2;
      var tween = gsap$2.to(target, _setDefaults$1((_setDefaults2 = {}, _setDefaults2[property] = "+=0.1", _setDefaults2.paused = true, _setDefaults2.stagger = 0, _setDefaults2), vars || {})), func = function func2(value, start, startIsRelative) {
  ...
  */
  var gsap, _coreInitted, _win, _doc, _docEl, _body, _root, _resizeDelay, _toArray, _clamp, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup = 1, _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp2(value, type, self2) {
    ...
    var snap2 = gsap.utils.snap(snapIncrementOrArray), a = Array.isArray(snapIncrementOrArray) && snapIncrementOrArray.slice(0).sort(function(a2, b) {
      return a2 - b;
    });
  ...
  class AnimateContent {
    constructor(options = {}, gsap2, ScrollTrigger2) {
      this.options = options;
      Object.assign(this, defaults, options);
      this.gsap = gsap2;
      this.ScrollTrigger = ScrollTrigger2;
      this.mm = gsap2.matchMedia();
      this._isBrowser = typeof window !== "undefined" && typeof document !== "undefined";
      if (this._isBrowser) {
  ...
  class BycAnimations {
    ...
    init() {
      if (!this._isBrowser) return;
      const prefersMotion = typeof window.matchMedia === "function" ? window.matchMedia("(prefers-reduced-motion: no-preference)") : { matches: true };
  ...
  exports2.default = BycAnimations;
