(function (global, factory) {
  ...
  (global = global || self, global.BycAnimations = factory());
})(this, (function () {
  ...
  */
  ...
  var defaults = {
    ...
    // todo: testing
    scrollDuration: 1.2,
    scrollEasing: function scrollEasing(t) {
  ...
  var SmoothScroll = /*#__PURE__*/function () {
    ...
    _proto.init = function init() {
      ...
      var content = this.scrollContent || document.documentElement;
      var wrapper = this.scrollWrapper || window;
  ...
  var AnimateContent = /*#__PURE__*/function () {
    function AnimateContent(options, gsap, ScrollTrigger) {
      if (options === void 0) {
        options = {};
      }
    ...
    var _proto = AnimateContent.prototype;
    _proto.setAnimateAttributes = function setAnimateAttributes(target, parent) {
      if (parent === void 0) {
        parent = null;
      }
      try {
        ...
        if (thisTarget.hasAttribute('data-animate-easing')) {
          target.style.setProperty("--" + _this.prefix + "-animate-easing", thisTarget.getAttribute('data-animate-easing'));
        }
        if (thisTarget.hasAttribute('data-animate-duration')) {
          target.style.setProperty("--" + _this.prefix + "-animate-duration", thisTarget.getAttribute('data-animate-duration') + 's');
        }
        if (thisTarget.hasAttribute('data-animate-delay')) {
          target.style.setProperty("--" + _this.prefix + "-animate-delay", thisTarget.getAttribute('data-animate-delay') + 's');
        }
        if (thisTarget.hasAttribute('data-animate-delay-mobile')) {
          target.style.setProperty("--" + _this.prefix + "-animate-delay-mobile", thisTarget.getAttribute('data-animate-delay-mobile'));
        }
        /* Fade / Opacity */
        if (thisTarget.hasAttribute('data-animate-opacity-duration')) {
          target.style.setProperty("--" + _this.prefix + "-animate-opacity-duration", thisTarget.getAttribute('data-animate-opacity-duration') + 's');
        }
        if (thisTarget.hasAttribute('data-animate-opacity-start')) {
          target.style.setProperty("--" + _this.prefix + "-animate-opacity-start", thisTarget.getAttribute('data-animate-opacity-start'));
        }
        if (thisTarget.hasAttribute('data-animate-opacity-end')) {
          target.style.setProperty("--" + _this.prefix + "-animate-opacity-end", thisTarget.getAttribute('data-animate-opacity-end'));
        }
        /* Reveal */
        if (thisTarget.hasAttribute('data-animate-border-radius')) {
          target.style.setProperty("--" + _this.prefix + "-animate-border-radius", thisTarget.getAttribute('data-animate-border-radius'));
        }
        if (thisTarget.hasAttribute('data-animate-background')) {
          target.style.setProperty("--" + _this.prefix + "-animate-background-color", thisTarget.getAttribute('data-animate-background'));
        }
        if (thisTarget.hasAttribute('data-animate-foreground')) {
          target.style.setProperty("--" + _this.prefix + "-animate-foreground-color", thisTarget.getAttribute('data-animate-foreground'));
        }
        if (thisTarget.hasAttribute('data-animate-reveal-delay')) {
          target.style.setProperty("--" + _this.prefix + "-animate-reveal-delay-extra", thisTarget.getAttribute('data-animate-reveal-delay') + 's');
        }
        ...
        if (thisTarget.hasAttribute('data-animate-slide-offset')) {
          target.style.setProperty("--" + _this.prefix + "-animate-slide-offset", thisTarget.getAttribute('data-animate-slide-offset'));
        }
        /* Zoom */
        if (thisTarget.hasAttribute('data-animate-zoom-start')) {
          target.style.setProperty("--" + _this.prefix + "-animate-zoom-start", thisTarget.getAttribute('data-animate-zoom-start'));
        }
        if (thisTarget.hasAttribute('data-animate-zoom-end')) {
          target.style.setProperty("--" + _this.prefix + "-animate-zoom-end", thisTarget.getAttribute('data-animate-zoom-end'));
        }
    ...
    _proto.init = function init() {
      ...
      var myBlocks = this.wrapper.querySelectorAll('[data-animate]');
      if (myBlocks) {
        this.gsap.utils.toArray(myBlocks).forEach(function (target) {
          ...
          _this2.ScrollTrigger.create({
            ...
            onEnterBack: function onEnterBack() {
              target.classList.add(_this2.inViewClass);
              target.classList.remove(_this2.outViewClass);
            },
            onLeave: function onLeave() {
              if (isRepeatable == true) {
                target.classList.add(_this2.outViewClass);
              }
            },
            onLeaveBack: function onLeaveBack() {
              if (isRepeatable) {
                target.classList.remove(_this2.inViewClass);
              }
            },
            once: !isRepeatable
          });
      ...
      var batches = this.wrapper.querySelectorAll('[data-animate-batch]');
      if (batches) {
        var _loop = function _loop() {
          var batch = _step.value;
          var targets = batch.querySelectorAll(batch.dataset.animateBatch);
          ...
          if (targets) {
            ...
            _this2.ScrollTrigger.batch(targets, {
              ...
              onEnterBack: function onEnterBack(elements) {
                _this2.gsap.to(elements, {
                  stagger: {
                    each: animateDelay,
                    onComplete: function onComplete() {
              ...
              onLeaveBack: function onLeaveBack(elements) {
                if (isRepeatable) {
                  _this2.gsap.to(elements, {
                    stagger: {
                      each: animateDelay,
  ...
  var Parallax = /*#__PURE__*/function () {
    function Parallax(options, gsap, ScrollTrigger) {
      if (options === void 0) {
        options = {};
      }
      Object.assign(this, defaults, options);
    ...
    _proto.init = function init() {
      var _this = this;
      if (!this._isBrowser || !this.wrapper) return;
      var nodes = this.wrapper.querySelectorAll('[data-parallax-from]');
      this.gsap.utils.toArray(nodes).forEach(function (target) {
        var toAttr = target.getAttribute("data-parallax-to");
        if (toAttr) {
          var fromAttr = target.getAttribute("data-parallax-from");
          var fromObject = {};
          var toObject = null;
          ...
          var isScrub = _this.parallaxScrub;
          if (isScrubString !== null) {
            var v = isScrubString.trim();
            if (v === "true" || v === "false") {
              isScrub = v === "true";
            } else {
              var n = Number(v);
              isScrub = Number.isNaN(n) ? _this.parallaxScrub : n;
            }
          }
          var thisTranslate = _this.gsap.fromTo(target, fromObject, toObject);

          // Resolve trigger relative to wrapper when a selector is provided; fallback to global selector or the element itself
          var triggerSelector = target.dataset.parallaxTrigger;
          var resolvedTrigger = triggerSelector ? _this.wrapper.querySelector(triggerSelector) || triggerSelector : target;

          // Resolve markers: allow per-element override via data-parallax-markers
          var markersOpt = _this.parallaxMarkers;
          if (Object.prototype.hasOwnProperty.call(target.dataset, 'parallaxMarkers')) {
            var raw = target.dataset.parallaxMarkers;
            if (raw === '' || raw === 'true') {
              markersOpt = true;
            } else if (raw === 'false') {
              markersOpt = false;
          ...
          _this.ScrollTrigger.create({
            ...
            start: target.dataset.parallaxStart ? target.dataset.parallaxStart : _this.parallaxStart,
            end: target.dataset.parallaxEnd ? target.dataset.parallaxEnd : _this.parallaxEnd,
            scrub: isScrub,
  ...
  //------------------------------------------------------------------------
  var BycAnimations = /*#__PURE__*/function () {
    function BycAnimations(options) {
      if (options === void 0) {
        options = {};
      }
      this.options = options;
    ...
    _proto.init = function init() {
      ...
      var prefersMotion = typeof window.matchMedia === 'function' ? window.matchMedia('(prefers-reduced-motion: no-preference)') : {
        matches: true
      };
    ...
    _proto.initAnimations = function initAnimations() {
      ...
      new Parallax(this.options, gsapWithCSS, ScrollTrigger);
    };
    _proto.destroy = function destroy(animate, scroll) {
      if (animate === void 0) {
        animate = true;
      }
      if (scroll === void 0) {
