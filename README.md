...
| ---------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `destroy(animate, scroll)`   | `Destroys the scroll events.`                              | <ul style="padding-left: 15px;"><li>`animate` (boolean): Destroy lenis scroll, `true` by default.</li><li>`scroll` (boolean): Destroy all scroll triggers, `true` by default.</li></ul>       |
